...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (reportType === 'orcamento') {
      ...
      const empresaNome = empresa.nome || 'Luce Nera';
      ...
      page.drawText(empresaNome, { x: headerTextX, y: textY, size: 14, font: boldFont });
      ...
      page.drawText(empresaNome, { x: width - 195, y: textY - 45, size: 8, font });
      ...
      page.drawText(budget.condicoes_pagamento || 'Dinheiro', { x: width - 250, y: y - 12, size: 9, font: boldFont });
