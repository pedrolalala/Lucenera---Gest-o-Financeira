...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (reportType === 'orcamento') {
      ...
      if (logoBase64) {
        try {
          ...
          page.drawImage(image, {
            ...
            height:
              imgDims.width > 100
                ? 100 * (imgDims.height / imgDims.width)
                : imgDims.height,
          })
        } catch (e) {
      ...
      page.drawText(`Data Impressão ${new Date().toLocaleString('pt-BR')}`, {
        x: width - 150,
        y: height - 102,
        size: 6,
        font,
      ...
      items.forEach((item: any) => {
        ...
        page.drawText(`R$ ${preco.toFixed(2)}`, {
          x: xOffsets[4],
          y,
          size: 8,
          font,
      ...
      page.drawText(`R$ ${subtotal.toFixed(2)}`, {
        x: width - 100,
        y: y - 15,
        size: 10,
        font,
      ...
      page.drawText(`R$ ${globalDesc.toFixed(2)}`, {
        x: width - 100,
        y: y - 30,
        size: 10,
        font,
